...
export default function ShopProfile() {
    ...
    const handleSaveDescription = async () => {
        try {
            ...
            const response = await fetch(`http://localhost:8081/api/shops/${id}/description`, {
                method: "PUT",
                headers: {
            ...
            if (response.ok) {
                ...
                setShopData(prev => ({
                    ...prev, 
                    shop: { ...prev.shop, description: description }
                }));
            } else {
                alert("Lỗi không thể cập nhật mô tả!");
            }
        } catch (err) {
    ...
    const handleAddVoucher = async () => {
        ...
        if (Number(newVoucher.discount) <= 0 || Number(newVoucher.discount) > 100) {
            setError("Phần trăm giảm giá chỉ được phép từ 1% đến 100%!");
            return;
        }       
        ...
        try {
            ...
            const formattedNewVoucher = {
                ...
                discount: createdVoucher.discountValue + "%",
                ...
                <div className='shop-info'>
                        ...
                        <div className='shop-details'>
                            ...
                            {isEditingDesc ? (
                                <div className="edit-desc-area">
                                    ...
                                    />
                                    <br />
                                    <button className="btn-save-desc" onClick={handleSaveDescription}>Lưu</button>
                                </div>
                            ) : (
                    ...
                    <div className='info-right'>
                        <div className='stats'>
                            ...
                            <div className='stat-item'>
                                <strong>{formatNumber(shopData?.shop?.followerCount || 0)}</strong>
                                <span>Theo dõi</span>
                            </div>
                            <div className='stat-item'>
